...
export async function GET(request: NextRequest) {
    ...
    const acpYear = searchParams.get('acpYear') || ''; // Required

    const apiKey = process.env.PUBLIC_DATA_API_KEY || process.env.G2B_API_KEY;

    // URL: http://apis.data.go.kr/1192000/service/OceansSeaareaImpactService1/getOceansSeaareaImpactInfo1
    const baseUrl = 'http://apis.data.go.kr/1192000/service/OceansSeaareaImpactService1/getOceansSeaareaImpactInfo1';
